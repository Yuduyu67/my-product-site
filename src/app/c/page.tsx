...
export default function CMentorPage() {
  ...
  const { conversation, loading, restoring, error, sendMessage, deleteExchange, clearConversation } = useChat("C/C++");
  ...
  function handleGiveUp() {
    return sendMessage("我卡住了，请直接告诉我答案。", "", "C/C++", { giveUp: true });
  }
    ...
    <div style={{ height: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <div className="cm-lab-layout">
        <div className="cm-lab-left">
          <CodeInputPanel onSend={sharedMode ? undefined : sendMessage} loading={loading} language="C/C++" />
        </div>
