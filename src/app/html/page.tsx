...
export default function HTMLCSTMentorPage() {
  ...
  const { conversation, loading, restoring, error, sendMessage, deleteExchange, clearConversation } = useChat("HTML/CSS");
  ...
  function handleGiveUp() {
    return sendMessage("我卡住了，请直接告诉我答案。", "", "HTML/CSS", { giveUp: true });
  }
  ...
  return (
    <div style={{ height: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <header className="cm-lab-header">
        ...
        <span className="cm-lab-title">🎨 HTML/CSS 实验排错导师舱</span>
      ...
      <div className="cm-lab-layout">
        <div className="cm-lab-left">
          <CodeInputPanel onSend={sharedMode ? undefined : sendMessage} loading={loading} language="HTML/CSS" />
        </div>
