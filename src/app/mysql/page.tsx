...
export default function MySQLMentorPage() {
  const scene = SCENES.mysql[0];
  ...
  function handleGiveUp() {
    return sendMessage("我卡住了，请直接告诉我答案。", "", "MySQL", { giveUp: true });
  }
  ...
  return (
    <div style={{ height: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <header className="cm-lab-header">
        ...
        <span className="cm-lab-title">🗄️ MySQL 实验排错导师舱</span>
      ...
      <div className="cm-lab-layout">
        <div className="cm-lab-left">
          <CodeInputPanel onSend={sharedMode ? undefined : sendMessage} loading={loading} language="MySQL" />
        </div>
